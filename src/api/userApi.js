...
import { getToken } from '../authUtils/authUtils'; // New utility for token management

// Auth-related endpoints
export const registerUser = (userData) =>
    post('/register', userData, null, 'multipart/form-data');

export const loginUser = async (userData) =>
    post('/login', userData).then((data) => data.access_token);

export const fetchProfile = () =>
    get('/profile', getToken());
...
export const resetPassword = (token, newPassword) =>
    post(`/reset-password/${token}`, { new_password: newPassword });

// Image management
export const uploadImage = (formData) =>
    post('/upload-image', formData, getToken(), 'multipart/form-data');
